...
#
# Runs face + mask detection on a single still image and shows the result
# in a window. Press any key to close.

# import the necessary packages
import os
# Pin to the Keras 2 API so a model saved by the Keras-2 training pipeline
# loads cleanly. Must be set before TensorFlow is imported.
